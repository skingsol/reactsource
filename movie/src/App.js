...
function App() {
  ...
  const getMovie = () => {
    ...
    // .catch(데이터가 잘 도착하지 않았을때 처리 )

    let url = "https://kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=f5eef3421c602c6cb7ea224104795888&targetDt=20230803";
    axios
      .get(url)
      .then((response) => {
