...
// 페이지 이동
// 1) a 태그
// 2) react 방법 - <Link to = '이동 경로' />,
//                        useNavigate() : setShoes 설정된 값 유지를 위해서는 이 방법으로 이동
        ...
        <Row className="mt-3 mx-3">
          <Button
            ...
            onClick={() => {
              ...
              if (count === 0) {
                url = "https://skingsol.github.io/product.json";
              } else if (count === 1) {
                url = "https://skingsol.github.io/product2.json";
              } else {
